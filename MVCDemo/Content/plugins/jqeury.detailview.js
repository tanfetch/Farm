        ...
        return jq.each(function () {
            ...
            $(self).datagrid({
                ...
                onExpandRow: function (index, row) {
                    var ddv = $(self).datagrid('getRowDetail', index).find('div.ddv');
                    ddv.panel({
                        border: false,
                        cache: true,
                        href: url + '&id=' + row.ID,
                        onLoad: function () {
                            $(self).datagrid('fixDetailRowHeight', index);
                            $(self).datagrid('selectRow', index);
                            ddv.find('a.save').click(function () {
                                var fm = $(self).datagrid('getRowDetail', index).find('form');
                                fm.ajaxSubmit({
                            ...
                            ddv.find('a.cancel').click(function () {
                                var row = $(self).datagrid('getRows')[index];
                                if (row.isNewRecord) {
